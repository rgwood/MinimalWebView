...
namespace Windows.Win32
{
	...
	using win32 = global::Windows.Win32;
        		...
        		/// <summary>
		        /// Represents a Win32 handle that can be closed with <see cref="PInvoke.DeleteObject"/>.
		        /// </summary>
	internal class DeleteObjectSafeHandle
:SafeHandle	{
...
this.SetHandle(preexistingHandle);
		...
		protected override bool ReleaseHandle() => PInvoke.DeleteObject((win32.Graphics.Gdi.HGDIOBJ)this.handle);
	}
}
